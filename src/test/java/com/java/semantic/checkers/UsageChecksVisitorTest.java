...
public class UsageChecksVisitorTest {
    ...
    static void tearUp() {
        ...
        Path testOutputDirectory =
            Path.of("src", "test", "resources", "semantic-test-output", "checkers", "usage-checks");
    ...
    void givenTestCases_whenLexerUsed_thenCorrectOutput() {
        ...
        TESTCASES_INPUT.forEach((key, value) -> {
            ...
            try {
                ...
                var checker = new UsageChecksVisitor();
            ...
            if (isOK) {
                ...
                System.out.println("\uD83C\uDF32 Checked by: UsageChecksVisitor\n");
